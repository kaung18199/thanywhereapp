...
import ListAttraction from "../components/Layout/ListAttraction";
...
const Hotel = () => {
  ...
  const goExploreAction = () => {
    ...
    if (chooseDestination != "") {
      router.push({
        pathname: "/result/attraction/[attraction]",
        params: {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
        ...
        <HeaderPart>
          <View style={{ paddingHorizontal: 16 }}>
            ...
            <View style={{ paddingTop: 15, gap: 8 }}>
              ...
              <SearchPart
                text={selectedConfirmDate ? selectedConfirmDate : "select date"}
                handleIndexPreps={() => {
                  handle2OpenPreps();
                }}
                style=""
      ...
      <View style={{ flex: 1 }}>
        <ListAttraction setStickyHeader={setStickyHeader} />
      </View>
          ...
          >
            ...
            >
              ...
              <Text
                ...
                className=" font-psemibold"
              >
                Select Attraction Type ( options * )
              </Text>
          ...
          <ScrollView className=" px-6 w-full">
            {type?.map((item, index) => (
              ...
              >
                <View
                  className={`rounded-full py-4 gap-x-2 w-full flex-1 flex-row justify-start items-center ${
                    destination_id == item.id ? "border-b border-secondary" : ""
                  }`}
                >
                  <Image
                    source={icons.locationPin}
