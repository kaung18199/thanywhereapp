...
const LoadingCart = () => {
  return (
    <View className=" flex flex-col gap-1 bg-white px-2 pt-1 pb-4 rounded-2xl ">
      ...
      <View className=" bg-gray-200 animate-pulse rounded-xl h-4 w-32 mt-8 overflow-hidden">
        <Text>.</Text>
      </View>
      <View className=" bg-gray-200 animate-pulse rounded-xl h-4 w-32 overflow-hidden">
        <Text>.</Text>
      </View>
    </View>
  );
